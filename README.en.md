...
The samples below use different original references. Panel 153 generated each one independently in a single pass, and AI metadata has been removed. Landscape samples are strict 50:50 left–right pairs with reality on the left and design on the right; portrait samples are strict 50:50 top–bottom pairs with reality above and design below.

Sample limitations: some landscapes retain too much detail and oversized subjects, falling short of sparse naive doodles and a stamp-sized anchor. Single-pass results are retained to conserve compute, not presented as fully compliant benchmarks; runtime acceptance remains strict.
